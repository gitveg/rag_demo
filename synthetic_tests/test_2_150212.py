"""
User Query: Configure the Genesis viewer to render at a non-standard resolution (e.g., 1920x1200) and set up a headless recording to save frames directly to disk without opening a GUI window.
"""

"""
User Query: Set up a two-phase MPM simulation (e.g., water and sand) with different material parameters and a barrier to separate the initial emitter regions.
"""

"""
User Query: Initialize an MPM fluid simulation with a custom non-Newtonian viscosity model where viscosity changes based on local shear rate, and configure the emitter to pulse at intervals.
"""

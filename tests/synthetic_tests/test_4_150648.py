"""
User Query: Create a soft body sphere, pin specific vertices identified by their index to a kinematic rigid body, and animate the rigid body to deform the soft body.
"""
